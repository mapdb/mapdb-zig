...
pub const I64ArrayList = struct {
    ...
    pub fn toImmutable(self: *const I64ArrayList) @import("../immutable/immutable.zig").ImmutableI64ArrayList {
        return @import("../immutable/immutable.zig").ImmutableI64ArrayList.fromMutable(self.config.base, self);
    }
