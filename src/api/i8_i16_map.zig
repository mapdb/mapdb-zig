...
/// Comptime interface for read-only maps from `i8` keys to `i16` values.
///
/// Equivalent to:
///   Go:   I8I16MapIterable interface
///   Rust: I8I16Map trait
///   Java: I8I16Map interface
pub fn assertI8I16Map(comptime T: type) void {
    comptime {
...
/// Comptime interface for mutable maps from `i8` to `i16`.
pub fn assertI8I16MutableMap(comptime T: type) void {
    assertI8I16Map(T);
    comptime {
...
// Compile-time verification: every concrete `i8` → `i16` map type
...
comptime {
    ...
    const HashMap = hashmap.i8_i16_hash_map.I8I16HashMap;
    assertI8I16MutableMap(HashMap);

    const TreeMap = treemap.i8_i16_tree_map.I8I16TreeMap;
    assertI8I16MutableMap(TreeMap);

    const HashBiMap = hashmap.i8_i16_hash_bi_map.I8I16HashBiMap;
    assertI8I16MutableMap(HashBiMap);

    const ImmutableHashMap = immutable.immutable_i8_i16_hash_map.ImmutableI8I16HashMap;
    assertI8I16Map(ImmutableHashMap);
}
