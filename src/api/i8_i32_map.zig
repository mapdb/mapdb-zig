...
/// Comptime interface for read-only maps from `i8` keys to `i32` values.
///
/// Equivalent to:
///   Go:   I8I32MapIterable interface
///   Rust: I8I32Map trait
///   Java: I8I32Map interface
pub fn assertI8I32Map(comptime T: type) void {
    comptime {
...
/// Comptime interface for mutable maps from `i8` to `i32`.
pub fn assertI8I32MutableMap(comptime T: type) void {
    assertI8I32Map(T);
    comptime {
...
comptime {
    ...
    const HashMap = hashmap.i8_i32_hash_map.I8I32HashMap;
    assertI8I32MutableMap(HashMap);

    const TreeMap = treemap.i8_i32_tree_map.I8I32TreeMap;
    assertI8I32MutableMap(TreeMap);

    const HashBiMap = hashmap.i8_i32_hash_bi_map.I8I32HashBiMap;
    assertI8I32MutableMap(HashBiMap);

    const ImmutableHashMap = immutable.immutable_i8_i32_hash_map.ImmutableI8I32HashMap;
    assertI8I32Map(ImmutableHashMap);
}
